...
#' process:
#' \deqn{cases_t \sim neg-binomial(R0 \sum_s=1^\infty w(s) cases_t-s, kappa)}
...
#' recent to past
#' @param weights a vector containing weights representing the latency
#' distribution
#'
#' @return a count of cases
true_cases_single <- function(R0, kappa, cases_history, weights){
